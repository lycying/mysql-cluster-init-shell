#!/bin/sh
mkdir -p /opt/liguo/data/14001
/opt/liguo/mysql/bin/mysqld --initialize-insecure --basedir=/opt/liguo/mysql --datadir=/opt/liguo/data/14001
...
chown -R mysql:mysql /opt/liguo/data/14001

#mysqld_safe only know it
ln -s /opt/liguo/mysql /usr/local/mysql

echo "start it.... wait 10 sec..."
/opt/liguo/mysql/bin/mysqld_safe --defaults-file=./my-10-1-6-229-15001.cnf &
...
/opt/liguo/mysql/bin/mysql -P14001  -S /opt/liguo/data/14001/mysql.sock -uroot  --skip-password -e " 
SET SQL_LOG_BIN=0;
...
SET SQL_LOG_BIN=1;
"
/opt/liguo/mysql/bin/mysql -P14001  -S /opt/liguo/data/14001/mysql.sock  -e "show databases"
