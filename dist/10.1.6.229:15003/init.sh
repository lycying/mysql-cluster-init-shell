#!/bin/sh
mkdir -p /opt/liguo/data/14003
/opt/liguo/mysql/bin/mysqld --initialize-insecure --basedir=/opt/liguo/mysql --datadir=/opt/liguo/data/14003
...
chown -R mysql:mysql /opt/liguo/data/14003

#mysqld_safe only know it
ln -s /opt/liguo/mysql /usr/local/mysql

echo "start it.... wait 10 sec..."
/opt/liguo/mysql/bin/mysqld_safe --defaults-file=./my-10-1-6-229-15003.cnf &
...
/opt/liguo/mysql/bin/mysql -P14003  -S /opt/liguo/data/14003/mysql.sock -uroot  --skip-password -e " 
SET SQL_LOG_BIN=0;
...
SET SQL_LOG_BIN=1;
"
/opt/liguo/mysql/bin/mysql -P14003  -S /opt/liguo/data/14003/mysql.sock  -e "show databases"
